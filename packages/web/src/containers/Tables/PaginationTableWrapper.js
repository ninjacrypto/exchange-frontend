      ...
      if (shouldFetchData) {
        try {
          ...
          if (response.data.status === 'Success') {
            ...
            setData(dataTransformer ? dataTransformer(rows) : rows);
            setNumPages(Math.ceil(totalRows / pageSize));
          }
        } catch (e) {
          console.log(e);
        }
...
export default withNamespaces()(PaginationTableWrapper);
